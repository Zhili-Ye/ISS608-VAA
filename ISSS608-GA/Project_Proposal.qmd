...
The rise of fintech has generated unprecedented volumes of customer behavioural data. Yet in many organisations, these insights remain locked behind technical barriers, preventing non-technical stakeholders from accessing them. The result is a critical gap between data and decision-making—one that leaves issues like the ‘silent churn’ undetected and unaddressed.

FinSight is our proposed R Shiny application designed to democratise access to these analytics. Rather than relying on static reports, FinSight empowers analysts and business users with interactive tools for exploratory analysis, statistical testing, customer segmentation, and predictive modelling—all without requiring programming expertise. By placing these capabilities directly in the hands of decision-makers, FinSight transforms data from a passive asset into an actionable driver of insight.

This application is built on the COFINFAD (Colombian Fintech Financial Analytics Dataset), which captures the full customer lifecycle of 48,723 customers from a Colombian fintech firm in 2023—encompassing demographics, product holdings, app engagement, transaction behaviour, satisfaction scores, and churn risk. The depth and diversity of this dataset provide a robust foundation for developing our multi-dimensional, interactive visual analytics platform, enabling richer insights and more informed decision-making.
...
|-------------------------------------|-------------------|
| Project Website Set-up & Publishing | Ye Zhili          |
| EDA & CDA modules                   | Teo Cher In       |
| Clustering (LCA) modules            | Cheng Ho Wang     |
| Decision Tree & Random Forest       | Ye Zhili          |
| Project Proposal                    | Cheng Ho Wang     |
| Project Minutes                     | Teo Cher In       |
| Project Poster                      | All               |
